...
import AccessibilityToggle from "./AccessibilityToggle"; // ⭐ add this
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        <nav className="fixed top-0 left-0 w-full bg-black text-white shadow-md flex justify-between items-center px-6 py-4 z-50">
          ...
          <ul className="flex gap-6">
            ...
            <li><Link href="/order" className="hover:text-orange-400 transition-colors">Order</Link></li>
        ...
        {/* ⭐ Accessibility Button (now a client component) */}
        <AccessibilityToggle />
